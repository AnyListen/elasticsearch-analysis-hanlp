...
import net.luculent.bigdata.nlp.helper.SegmentHelper;
import net.luculent.bigdata.nlp.segment.mode.PinyinMode;
import net.luculent.bigdata.nlp.segment.mode.TsMode;
